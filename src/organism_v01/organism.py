...
from organism_v01.cell import (
    ...
    RankSlotClaimFactorRuleCuedCellUpdate,
    RankSlotClaimResidualRuleCuedCellUpdate,
    RankSlotClaimRuleCuedCellUpdate,
...
class CellularOrganism(nn.Module):
    ...
    def __init__(
        ...
        if update_rule == "standard":
        ...
        elif update_rule == "rank_slot_claim_rule_cued":
            self.cell_update = RankSlotClaimRuleCuedCellUpdate(
                layout.total_channels,
                hidden_start=layout.hidden_start,
                hidden_channels=layout.hidden_channels,
                source_a=layout.source_a,
        ...
        elif update_rule == "rank_slot_claim_residual_rule_cued":
            self.cell_update = RankSlotClaimResidualRuleCuedCellUpdate(
                layout.total_channels,
                hidden_start=layout.hidden_start,
                hidden_channels=layout.hidden_channels,
                source_a=layout.source_a,
        ...
        elif update_rule == "rank_slot_claim_factor_rule_cued":
            self.cell_update = RankSlotClaimFactorRuleCuedCellUpdate(
                layout.total_channels,
                hidden_start=layout.hidden_start,
                hidden_channels=layout.hidden_channels,
                source_a=layout.source_a,
            ...
            self.cell_update = RelativeRankRuleCuedCellUpdate(
                layout.total_channels,
                hidden_start=layout.hidden_start,
                hidden_channels=layout.hidden_channels,
                source_a=layout.source_a,
